...
url_suffix <- "labourhoarding_total_sa_nace2.zip"
...
temp_sdmx_files <- sdmx_files[which(grepl("surveys_labourhoarding_sa_nace2.xlsx", sdmx_files))]
```
...
sectors <- c("AGGREGATE", "BUILDING", "INDUSTRY", "RETAIL", "SERVICES")
sector_labels <- c("Overall", "Construction", "Industry", "Retail", "Services")
